...
const InspectionDetailPage = () => {
    ...
    return (_jsxs(Box, { sx: { display: "flex", flexDirection: "column", gap: 3 }, children: [_jsxs(Breadcrumbs, { children: [_jsx(Link, { component: RouterLink, to: "/projects", color: "inherit", children: "Proyectos" }), _jsx(Link, { component: RouterLink, to: `/projects/${projectId}/inspections`, color: "inherit", children: "Inspecciones" }), _jsx(Typography, { color: "text.primary", children: inspection.structure_name })] }), _jsxs(Stack, { direction: { xs: "column", md: "row" }, alignItems: { md: "center" }, justifyContent: "space-between", spacing: 2, children: [_jsxs(Stack, { spacing: 1, children: [_jsx(Typography, { variant: "h4", fontWeight: 600, children: inspection.structure_name }), _jsxs(Stack, { direction: "row", spacing: 1, alignItems: "center", children: [_jsx(Chip, { label: conditionLabel, color: inspection.overall_condition === "operativa"
                                            ...
                                            }) })] }))] }) }), _jsx(DialogActions, { children: _jsx(Button, { onClick: () => setSummaryDialogOpen(false), children: "Cerrar" }) })] }), _jsx(Card, { children: _jsx(CardContent, { children: _jsxs(Stack, { spacing: 2, children: [_jsx(Typography, { variant: "h6", children: "Evaluaci\u00F3n de la inspecci\u00F3n" }), inspections.length === 0 ? (_jsx(Typography, { variant: "body2", color: "text.secondary", children: "No hay inspecciones registradas para evaluar." })) : (_jsx(_Fragment, { children: _jsxs(Box, { children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", sx: { mb: 1 }, children: "Resumen de la inspecci\u00F3n" }), _jsx(Stack, { spacing: 1, children: inspections.map((insp) => {
                                                const llmDetails = extractLLMDetails({
                                                    payload: insp.llm_payload,
                                                    reason: insp.llm_reason,
                                                    score: insp.llm_score,
                                                });
                                                return (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { sx: { py: 1, "&:last-child": { pb: 1 } }, children: [_jsxs(Stack, { direction: { xs: "column", sm: "row" }, spacing: 1, alignItems: { sm: "center" }, justifyContent: "space-between", children: [_jsxs(Stack, { direction: "row", spacing: 1, alignItems: "center", flexWrap: "wrap", children: [_jsx(Typography, { variant: "body2", fontWeight: 600, children: insp.structure_name }), _jsx(Chip, { label: conditionOptions.find((c) => c.value === insp.overall_condition)?.label ?? "Sin dato", color: insp.overall_condition === "operativa"
                                                                                    ? "success"
                                                                                    : insp.overall_condition === "critica"
                                                                                        ? "error"
                                                                                        : "warning", size: "small" })] }), _jsxs(Stack, { direction: "row", spacing: 0.5, alignItems: "center", children: [_jsx(Chip, { label: `H: ${formatScoreValue(insp.deterministic_score)}`, color: getScoreColor(insp.deterministic_score), size: "small", sx: { fontSize: "0.7rem", height: 20 } }), _jsx(Chip, { label: `L: ${formatScoreValue(llmDetails.score)}`, color: getScoreColor(llmDetails.score), size: "small", sx: { fontSize: "0.7rem", height: 20 } })] })] }), llmDetails.reason && (_jsx(Typography, { variant: "caption", color: "text.secondary", sx: { mt: 0.5, display: "block", fontStyle: "italic" }, children: llmDetails.reason }))] }) }, insp.id));
