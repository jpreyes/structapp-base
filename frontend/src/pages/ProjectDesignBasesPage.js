...
const ProjectDesignBasesPage = () => {
    ...
    if (optionsLoading) {
        return (_jsx(Box, { sx: { display: "flex", justifyContent: "center", mt: 6 }, children: _jsx(Typography, { children: "Cargando cat\u00E1logos..." }) }));
    }
    if (isError || !options) {
        return (_jsx(Alert, { severity: "error", children: "No se pudieron recuperar las opciones base. Verifica la API e int\u00E9ntalo nuevamente." }));
    }
    return (_jsxs(Box, { sx: { display: "flex", flexDirection: "column", gap: 3 }, children: [_jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsx(Typography, { variant: "h5", gutterBottom: true, children: "Bases de c\u00E1lculo y cargas de dise\u00F1o" }), _jsxs(Stack, { direction: "row", spacing: 1, alignItems: "center", children: [_jsx(TextField, { select: true, label: "Proyecto", size: "small", value: projectId, onChange: (e) => {
                                    setProjectId(e.target.value);
                                }, disabled: projectsLoading, sx: { width: 300 }, children: projects.map((project) => (_jsx(MenuItem, { value: project.id, children: project.name }, project.id))) }), _jsx(Button, { variant: "outlined", startIcon: _jsx(FolderOpenIcon, {}), onClick: handleLoadList, disabled: !projectId, children: "Cargar" }), _jsx(Button, { variant: "contained", startIcon: _jsx(SaveIcon, {}), onClick: () => setSaveDialogOpen(true), disabled: !hasAnyResult || !projectId, children: "Guardar" }), _jsx(Button, { variant: "contained", color: "success", startIcon: _jsx(DescriptionIcon, {}), onClick: () => setGenerateDocDialogOpen(true), disabled: !hasAnyResult || !projectId, children: "Generar Word" }), _jsx(Button, { variant: "outlined", startIcon: _jsx(HistoryIcon, {}), onClick: handleViewHistory, disabled: !projectId, children: "Historial" })] })] }), _jsx(Card, { sx: { mb: 3 }, children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Descripci\u00F3n del Edificio" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, children: _jsx(TextField, { label: "Descripci\u00F3n General", value: buildingDescription, onChange: (e) => setBuildingDescription(e.target.value), fullWidth: true, multiline: true, rows: 3, placeholder: "Ej: Edificio de oficinas de 5 pisos con estructura de hormig\u00F3n armado..." }) }), _jsx(Grid, { item: true, xs: 12, md: 6, children: _jsx(TextField, { label: "Ubicaci\u00F3n", value: buildingLocation, onChange: (e) => setBuildingLocation(e.target.value), fullWidth: true, placeholder: "Ej: Av. Principal 123, Santiago" }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "\u00C1rea Total (m\u00B2)", value: buildingArea, onChange: (e) => setBuildingArea(e.target.value), fullWidth: true, placeholder: "Ej: 1250" }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "Altura Total (m)", value: buildingHeight, onChange: (e) => setBuildingHeight(e.target.value), fullWidth: true, placeholder: "Ej: 18.5" }) }), _jsxs(Grid, { item: true, xs: 12, children: [_jsx(Button, { variant: "contained", startIcon: _jsx(SaveIcon, {}), onClick: () => buildingDescriptionMutation.mutate(), disabled: !projectId ||
                                                !user?.id ||
                                            ...
                                            : windMutation.data.message }))] }) }) }), _jsx(Grid, { item: true, xs: 12, md: 8, children: _jsx(Card, { children: _jsxs(CardContent, { sx: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsx(Typography, { variant: "h6", children: "Cargas de nieve sobre techumbre" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Latitud (\u00B0)", value: latitudeBand, onChange: (event) => {
                                                        setLatitudeBand(event.target.value);
                                                        setAltitudeBand("");
                                                    }, fullWidth: true, children: Object.keys(options.snowLatitudeBands).map((lat) => (_jsx(MenuItem, { value: lat, children: lat }, lat))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Altitud (m.s.n.m.)", value: altitudeBand, onChange: (event) => setAltitudeBand(event.target.value), disabled: !latitudeBand, fullWidth: true, children: altitudeOptions.map((alt) => (_jsx(MenuItem, { value: alt, children: alt }, alt))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Condici\u00F3n t\u00E9rmica", value: thermalCondition, onChange: (event) => setThermalCondition(event.target.value), fullWidth: true, children: options.snowThermalConditions.map((option) => (_jsx(MenuItem, { value: option, children: option }, option))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Categor\u00EDa de importancia", value: importanceCategory, onChange: (event) => setImportanceCategory(event.target.value), fullWidth: true, children: options.snowImportanceCategories.map((option) => (_jsx(MenuItem, { value: option, children: option }, option))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Categor\u00EDa de exposici\u00F3n", value: exposureCategory, onChange: (event) => {
                                                        setExposureCategory(event.target.value);
                                                        setExposureCondition("");
                                                    }, fullWidth: true, children: Object.keys(options.snowExposureCategories).map((categoryKey) => (_jsx(MenuItem, { value: categoryKey, children: categoryKey }, categoryKey))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Condici\u00F3n de exposici\u00F3n", value: exposureCondition, onChange: (event) => setExposureCondition(event.target.value), disabled: !exposureCategory, fullWidth: true, children: exposureConditions.map((option) => (_jsx(MenuItem, { value: option, children: option }, option))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { select: true, label: "Tipo de superficie", value: surfaceType, onChange: (event) => setSurfaceType(event.target.value), fullWidth: true, children: options.snowSurfaceTypes.map((option) => (_jsx(MenuItem, { value: option, children: option }, option))) }) }), _jsx(Grid, { item: true, xs: 12, sm: 6, children: _jsx(TextField, { label: "Inclinaci\u00F3n (\u00B0)", type: "number", value: roofPitch, onChange: (event) => setRoofPitch(event.target.value), fullWidth: true }) })] }), _jsx(Button, { variant: "contained", onClick: () => snowMutation.mutate({
                                            latitudeBand,
                                            altitudeBand,
                                            thermalCondition,
                                            importanceCategory,
                                            ...
                                            !surfaceType ||
                                            !roofPitch ||
                                            snowMutation.isPending, children: "Calcular nieve sobre techo" }), snowMutation.isError && (_jsx(Alert, { severity: "error", children: "No hay datos para la combinaci\u00F3n seleccionada." })), snowMutation.data && (_jsxs(Box, { sx: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 1 }, children: [_jsx(Typography, { color: "text.secondary", children: "Pg (kN/m\u00B2)" }), _jsx(Typography, { children: snowMutation.data.pg?.toFixed(2) ?? 'N/A' }), _jsx(Typography, { color: "text.secondary", children: "ct" }), _jsx(Typography, { children: snowMutation.data.ct?.toFixed(2) ?? 'N/A' }), _jsx(Typography, { color: "text.secondary", children: "ce" }), _jsx(Typography, { children: snowMutation.data.ce?.toFixed(2) ?? 'N/A' }), _jsx(Typography, { color: "text.secondary", children: "I" }), _jsx(Typography, { children: snowMutation.data.I?.toFixed(2) ?? 'N/A' }), _jsx(Typography, { color: "text.secondary", children: "cs" }), _jsx(Typography, { children: snowMutation.data.cs?.toFixed(3) ?? 'N/A' }), _jsx(Typography, { color: "text.secondary", children: "pf (kN/m\u00B2)" }), _jsx(Typography, { children: snowMutation.data.pf?.toFixed(3) ?? 'N/A' })] }))] }) }) })] }), _jsx(Card, { children: _jsxs(CardContent, { sx: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsx(Typography, { variant: "h6", children: "An\u00E1lisis s\u00EDsmico base (NCh433)" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { select: true, label: "Categor\u00EDa estructural", value: seismicCategory, onChange: (event) => setSeismicCategory(event.target.value), fullWidth: true, children: options.seismicCategories.map((cat) => (_jsx(MenuItem, { value: cat, children: cat }, cat))) }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { select: true, label: "Zona s\u00EDsmica", value: seismicZone, onChange: (event) => setSeismicZone(event.target.value), fullWidth: true, children: options.seismicZones.map((zone) => (_jsx(MenuItem, { value: zone, children: zone }, zone))) }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { select: true, label: "Tipo de suelo", value: seismicSoil, onChange: (event) => setSeismicSoil(event.target.value), fullWidth: true, children: options.seismicSoils.map((soil) => (_jsx(MenuItem, { value: soil, children: soil }, soil))) }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "Coeficiente R", type: "number", value: rsValue, onChange: (event) => setRsValue(event.target.value), fullWidth: true }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "Peso s\u00EDsmico total (kN)", type: "number", value: psValue, onChange: (event) => setPsValue(event.target.value), fullWidth: true }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "Per\u00EDodo Tx (s)", type: "number", value: txValue, onChange: (event) => setTxValue(event.target.value), fullWidth: true }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "Per\u00EDodo Ty (s)", type: "number", value: tyValue, onChange: (event) => setTyValue(event.target.value), fullWidth: true }) }), _jsx(Grid, { item: true, xs: 12, md: 3, children: _jsx(TextField, { label: "R\u00E2'\u20AC (deriva)", type: "number", value: r0Value, onChange: (event) => setR0Value(event.target.value), fullWidth: true }) })] }), _jsx(Divider, {}), _jsx(Typography, { variant: "subtitle1", children: "Distribuci\u00F3n de niveles" }), _jsxs(Stack, { spacing: 1, children: [stories.map((story, index) => (_jsxs(Stack, { direction: { xs: "column", sm: "row" }, spacing: 2, alignItems: "center", children: [_jsxs(Typography, { variant: "body2", children: ["Nivel ", index + 1] }), _jsx(TextField, { label: "Altura (m)", type: "number", value: story.height, onChange: (event) => handleStoryChange(story.id, "height", event.target.value), sx: { minWidth: 140 } }), _jsx(TextField, { label: "Peso (kN)", type: "number", value: story.weight, onChange: (event) => handleStoryChange(story.id, "weight", event.target.value), sx: { minWidth: 140 } }), _jsx(IconButton, { "aria-label": "Eliminar nivel", onClick: () => handleRemoveStory(story.id), disabled: stories.length <= 1, children: _jsx(DeleteIcon, { fontSize: "small" }) })] }, story.id))), _jsx(Button, { startIcon: _jsx(AddIcon, {}), onClick: handleAddStory, variant: "outlined", sx: { alignSelf: "flex-start" }, children: "Agregar nivel" })] }), _jsx(Button, { variant: "contained", onClick: () => seismicMutation.mutate({
                                category: seismicCategory,
                                zone: seismicZone,
                                soil: seismicSoil,
                                rs: Number(rsValue),
                                ...
                                !r0Value ||
                                !storiesValid ||
                                seismicMutation.isPending, children: "Calcular espectro y fuerzas" }), seismicMutation.isError && (_jsx(Alert, { severity: "error", children: seismicErrorMessage ?? "Verifica los valores ingresados; no se pudo calcular el análisis." })), seismicMutation.data && (_jsxs(Box, { sx: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsxs(Box, { sx: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 1 }, children: [_jsxs(Typography, { color: "text.secondary", children: ["I", _jsx("sub", { children: "s" })] }), _jsx(Typography, { children: seismicMutation.data.intensityFactor.toFixed(3) }), _jsxs(Typography, { color: "text.secondary", children: ["A", _jsx("sub", { children: "0" })] }), _jsx(Typography, { children: seismicMutation.data.zoneFactor.toFixed(3) }), _jsxs(Typography, { color: "text.secondary", children: ["Q", _jsx("sub", { children: "bas,x" })] }), _jsxs(Typography, { children: [seismicMutation.data.Qbasx.toFixed(3), " kN"] }), _jsxs(Typography, { color: "text.secondary", children: ["Q", _jsx("sub", { children: "bas,y" })] }), _jsxs(Typography, { children: [seismicMutation.data.Qbasy.toFixed(3), " kN"] }), _jsxs(Typography, { color: "text.secondary", children: ["Q", _jsx("sub", { children: "basal,m\u00EDn" })] }), _jsxs(Typography, { children: [seismicMutation.data.Q0Min.toFixed(3), " kN"] }), _jsxs(Typography, { color: "text.secondary", children: ["Q", _jsx("sub", { children: "basal,m\u00E1x" })] }), _jsxs(Typography, { children: [seismicMutation.data.Q0Max.toFixed(3), " kN"] })] }), _jsx(Typography, { variant: "subtitle2", children: "Distribuci\u00F3n de fuerzas por nivel" }), _jsx(DataGrid, { autoHeight: true, density: "compact", rows: seismicMutation.data.floorForces.map((row) => ({ id: row.level, ...row })), columns: [
                                    ...
                                    ], hideFooter: true }), _jsx(Typography, { variant: "subtitle2", children: "Espectro de dise\u00F1o (Sa)" }), _jsx(DataGrid, { autoHeight: true, density: "compact", rows: seismicMutation.data.spectrum.map((row, index) => ({ id: index, ...row })), columns: [
                                        {
                                            field: "period",
                                            headerName: "T (s)",
                                            width: 120,
                                        ...
                                        pagination: { paginationModel: { pageSize: 10, page: 0 } },
                                            ...
                                            !projectId ||
                                            !user?.id, children: "Dise\u00F1ar Pilar" }) })] }), concreteColumnMutation.isError && (_jsx(Alert, { severity: "error", sx: { mt: 2 }, children: getErrorMessage(concreteColumnMutation.error) || "Error al calcular el pilar" })), concreteColumnResult && (_jsxs(Box, { sx: { mt: 3 }, children: [_jsx(Typography, { variant: "subtitle1", gutterBottom: true, children: "Resultados del Dise\u00F1o" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Capacidad Axial" }), _jsxs(Typography, { variant: "body1", children: [concreteColumnResult.axialCapacity?.toFixed(2) ?? 'N/A', " kN"] })] }), _jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Ratio de Utilizaci\u00F3n" }), _jsxs(Typography, { variant: "body1", color: (concreteColumnResult.axialCapacityRatio ?? 0) > 1 ? "error" : "success.main", children: [((concreteColumnResult.axialCapacityRatio ?? 0) * 100).toFixed(1), "%"] })] }), _jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Refuerzo Longitudinal" }), _jsxs(Typography, { variant: "body1", children: [concreteColumnResult.longitudinalSteel?.numBars ?? 'N/A', " \u03C6", concreteColumnResult.longitudinalSteel?.barDiameter ?? 'N/A', " (", concreteColumnResult.longitudinalSteel?.totalArea?.toFixed(0) ?? 'N/A', " mm\u00B2)"] })] }), _jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Estribos" }), _jsxs(Typography, { variant: "body1", children: ["\u03C6", concreteColumnResult.transverseSteel?.diameter ?? 'N/A', " @ ", concreteColumnResult.transverseSteel?.spacing ?? 'N/A', " mm"] })] }), _jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Esbeltez" }), _jsxs(Typography, { variant: "body1", children: [concreteColumnResult.slendernessRatio?.toFixed(2) ?? 'N/A', " ", concreteColumnResult.isSlender && "(Esbelto)"] })] }), _jsxs(Grid, { item: true, xs: 12, md: 6, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Factor de Magnificaci\u00F3n" }), _jsx(Typography, { variant: "body1", children: concreteColumnResult.magnificationFactor?.toFixed(3) ?? 'N/A' })] })] })] }))] }) }), _jsxs(Dialog, { open: saveDialogOpen, onClose: () => setSaveDialogOpen(false), children: [_jsx(DialogTitle, { children: "Guardar base de c\u00E1lculo" }), _jsx(DialogContent, { children: _jsx(TextField, { autoFocus: true, margin: "dense", label: "Nombre", fullWidth: true, value: saveName, onChange: (e) => setSaveName(e.target.value), placeholder: "Ej: Base s\u00EDsmica edificio X", helperText: `Se guardará en el proyecto: ${projects.find(p => p.id === projectId)?.name || "No seleccionado"}` }) }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: () => setSaveDialogOpen(false), children: "Cancelar" }), _jsx(Button, { onClick: handleSaveDesignBase, variant: "contained", children: "Guardar" })] })] }), _jsxs(Dialog, { open: loadDialogOpen, onClose: () => setLoadDialogOpen(false), maxWidth: "sm", fullWidth: true, children: [_jsx(DialogTitle, { children: "Cargar base de c\u00E1lculo" }), _jsx(DialogContent, { children: savedBases.length === 0 ? (_jsx(Typography, { color: "text.secondary", sx: { py: 2 }, children: "No hay bases guardadas para este proyecto" })) : (_jsx(List, { children: savedBases.map((base) => (_jsx(ListItem, { disablePadding: true, children: _jsx(ListItemButton, { onClick: () => handleLoadDesignBase(base.id), children: _jsx(ListItemText, { primary: base.name, secondary: new Date(base.createdAt).toLocaleString() }) }) }, base.id))) })) }), _jsx(DialogActions, { children: _jsx(Button, { onClick: () => setLoadDialogOpen(false), children: "Cerrar" }) })] }), _jsxs(Dialog, { open: generateDocDialogOpen, onClose: () => setGenerateDocDialogOpen(false), children: [_jsx(DialogTitle, { children: "Generar documento Word" }), _jsx(DialogContent, { children: _jsx(TextField, { autoFocus: true, margin: "dense", label: "Nombre del proyecto", fullWidth: true, value: docProjectName, onChange: (e) => setDocProjectName(e.target.value), placeholder: "Ej: Edificio Comercial Centro", helperText: "Este nombre aparecer\u00E1 en el documento generado" }) }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: () => setGenerateDocDialogOpen(false), children: "Cancelar" }), _jsx(Button, { onClick: handleGenerateDocument, variant: "contained", color: "success", children: "Generar" })] })] }), _jsxs(Dialog, { open: historyDialogOpen, onClose: () => setHistoryDialogOpen(false), maxWidth: "md", fullWidth: true, children: [_jsx(DialogTitle, { children: "Historial de documentos generados" }), _jsx(DialogContent, { children: runHistory.length === 0 ? (_jsx(Typography, { color: "text.secondary", sx: { py: 2 }, children: "No hay documentos generados para este proyecto" })) : (_jsx(List, { children: runHistory.map((run) => (_jsx(ListItem, { secondaryAction: _jsxs(Stack, { direction: "row", spacing: 1, children: [_jsx(IconButton, { onClick: () => handlePreviewDocument(run.id), title: "Ver preview", children: _jsx(VisibilityIcon, {}) }), _jsx(IconButton, { onClick: () => handleDownloadDocument(run.id), title: "Descargar", children: _jsx(DownloadIcon, {}) })] }), children: _jsx(ListItemText, { primary: run.name, secondary: new Date(run.createdAt).toLocaleString() }) }, run.id))) })) }), _jsx(DialogActions, { children: _jsx(Button, { onClick: () => setHistoryDialogOpen(false), children: "Cerrar" }) })] }), _jsxs(Dialog, { open: previewDialogOpen, onClose: () => setPreviewDialogOpen(false), maxWidth: "lg", fullWidth: true, children: [_jsxs(DialogTitle, { children: ["Preview: ", previewData?.name, _jsx(IconButton, { onClick: () => handleDownloadDocument(previewData?.id), sx: { position: "absolute", right: 60, top: 8 }, title: "Descargar", children: _jsx(DownloadIcon, {}) })] }), _jsx(DialogContent, { children: previewData && (_jsxs(Box, { sx: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Informaci\u00F3n del Documento" }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Nombre:" }), " ", previewData.name] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Fecha de creaci\u00F3n:" }), " ", new Date(previewData.createdAt).toLocaleString()] })] }) }), previewData.data.buildingDescription && (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Descripci\u00F3n del Edificio" }), previewData.data.buildingDescription.text && (_jsxs(Typography, { variant: "body2", paragraph: true, children: [_jsx("strong", { children: "Descripci\u00F3n:" }), " ", previewData.data.buildingDescription.text] })), previewData.data.buildingDescription.location && (_jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Ubicaci\u00F3n:" }), " ", previewData.data.buildingDescription.location] })), previewData.data.buildingDescription.area && (_jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "\u00C1rea total:" }), " ", previewData.data.buildingDescription.area, " m\u00B2"] })), previewData.data.buildingDescription.height && (_jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Altura:" }), " ", previewData.data.buildingDescription.height, " m"] }))] }) })), previewData.data.liveLoad && (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Cargas Vivas" }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Tipo de edificio:" }), " ", previewData.data.liveLoad.buildingType] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Uso:" }), " ", previewData.data.liveLoad.usage] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Carga uniforme:" }), " ", previewData.data.liveLoad.uniformLoadRaw] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Carga concentrada:" }), " ", previewData.data.liveLoad.concentratedLoadRaw] })] }) })), previewData.data.wind && (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Presi\u00F3n de Viento" }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Entorno:" }), " ", previewData.data.wind.environment] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Altura:" }), " ", previewData.data.wind.height, " m"] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Presi\u00F3n:" }), " ", previewData.data.wind.q?.toFixed(2), " kgf/m\u00B2"] })] }) })), previewData.data.seismic && (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "An\u00E1lisis S\u00EDsmico" }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Categor\u00EDa:" }), " ", previewData.data.seismic.params.category] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Zona:" }), " ", previewData.data.seismic.params.zone] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Suelo:" }), " ", previewData.data.seismic.params.soil] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Qbas,x:" }), " ", previewData.data.seismic.result.Qbasx?.toFixed(2), " kN"] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Qbas,y:" }), " ", previewData.data.seismic.result.Qbasy?.toFixed(2), " kN"] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Q0,min:" }), " ", previewData.data.seismic.result.Q0Min?.toFixed(2), " kN"] }), _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Q0,max:" }), " ", previewData.data.seismic.result.Q0Max?.toFixed(2), " kN"] })] }) })), previewData.data.structural && (_jsx(Card, { variant: "outlined", children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "C\u00E1lculos Estructurales" }), previewData.data.structural.concreteColumn && (_jsxs(Box, { sx: { mb: 2 }, children: [_jsx(Typography, { variant: "subtitle1", gutterBottom: true, children: "Pilar de Hormig\u00F3n Armado (ACI318)" }), _jsxs(Grid, { container: true, spacing: 1, children: [_jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Capacidad Axial:" }), " ", previewData.data.structural.concreteColumn.axialCapacity?.toFixed(2), " kN"] }) }), _jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Ratio de Utilizaci\u00F3n:" }), " ", (previewData.data.structural.concreteColumn.axialCapacityRatio * 100)?.toFixed(1), "%"] }) }), _jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Refuerzo Longitudinal:" }), " ", previewData.data.structural.concreteColumn.longitudinalSteel?.numBars, " \u03C6", previewData.data.structural.concreteColumn.longitudinalSteel?.barDiameter] }) }), _jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Estribos:" }), " \u03C6", previewData.data.structural.concreteColumn.transverseSteel?.diameter, " @ ", previewData.data.structural.concreteColumn.transverseSteel?.spacing, " mm"] }) }), _jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "Esbeltez:" }), " ", previewData.data.structural.concreteColumn.slendernessRatio?.toFixed(2)] }) }), _jsx(Grid, { item: true, xs: 6, children: _jsxs(Typography, { variant: "body2", children: [_jsx("strong", { children: "\u00BFEs Esbelto?:" }), " ", previewData.data.structural.concreteColumn.isSlender ? "Sí" : "No"] }) })] })] }))] }) }))] })) }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: () => setPreviewDialogOpen(false), children: "Cerrar" }), _jsx(Button, { variant: "contained", startIcon: _jsx(DownloadIcon, {}), onClick: () => handleDownloadDocument(previewData?.id), children: "Descargar Documento" })] })] }), _jsx(Snackbar, { open: autoSaveSnackbar, autoHideDuration: 3000, onClose: () => setAutoSaveSnackbar(false), message: "Guardado autom\u00E1ticamente en el historial", anchorOrigin: { vertical: 'bottom', horizontal: 'right' } })] }));
};
